...
<?php
    ...
    $link7="<a href='https://sote.kainuu.fi/ikaihmiset'>https://sote.kainuu.fi/ikaihmiset</a>";
         ...
         $fetch= mysqli_query($connection, "SELECT p_id, priceh, pricekm, c_id, rate, alkm FROM hb_provide WHERE s_id=7"); 
...
?>
            ...
            <div id="myModal<?php echo $kk;?>" class="modal" data-modal=
                ...
                <div class="modal-content">
                    ...
                    <p style="font-weight:bold;">Kylvetyspalvelu asiakkaan kotona</p>
